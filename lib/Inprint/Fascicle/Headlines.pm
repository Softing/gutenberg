...
sub create {
    ...
    $c->check_access( \@errors, "editions.fascicle.manage:*", $fascicle->{edition});
...
sub update {
    ...
    $c->check_access( \@errors, "editions.fascicle.manage:*", $oldItem->{edition});
...
sub delete {
    ...
    $c->check_access( \@errors, "editions.fascicle.manage:*", $item->{edition});
