...
use constant ID      => "page";
use constant TABLE   => "fascicles_pages";
use constant COLUMNS => qw/ id edition fascicle origin headline seqnum w h created updated /;
...
#has '_holes'        => (isa => 'Any', metaclass => 'DoNotSerialize', is => 'rw', predicate => "has_holes");
#has '_modules'      => (isa => 'Any', metaclass => 'DoNotSerialize', is => 'rw', predicate => "has_modules");
#has '_requests'     => (isa => 'Any', metaclass => 'DoNotSerialize', is => 'rw', predicate => "has_requests");
#has '_documents'    => (isa => 'Any', metaclass => 'DoNotSerialize', is => 'rw', predicate => "has_documents");
