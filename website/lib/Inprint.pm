...
sub startup {
    ...
    $sessionBridge->route("/calendar/fascicle/copy/")                   ->to("calendar-fascicle#copy");
    ...
    $sessionBridge->route('/calendar/combos/copyfrom/')                 ->to('calendar-combos#copyfrom');
    ...
    # Templates
    $sessionBridge->route('/template/seance/')                          ->to('template#seance');

    $sessionBridge->route('/template/combos/headlines/')                ->to('template-combos#headlines');
    #$sessionBridge->route('/template/combos/rubrics/')                  ->to('template-combos#rubrics');
    $sessionBridge->route('/template/combos/templates/')                ->to('template-combos#templates');

    $sessionBridge->route("/template/pages/view/")                      ->to("template-pages#view");
    $sessionBridge->route("/template/pages/modules/")                   ->to("template-pages#modules");
    $sessionBridge->route("/template/pages/create/")                    ->to("template-pages#create");
    $sessionBridge->route("/template/pages/read/")                      ->to("template-pages#read");
    $sessionBridge->route("/template/pages/update/")                    ->to("template-pages#update");
    $sessionBridge->route("/template/pages/delete/")                    ->to("template-pages#delete");
    $sessionBridge->route("/template/pages/move/")                      ->to("template-pages#move");
    $sessionBridge->route("/template/pages/left/")                      ->to("template-pages#left");
    $sessionBridge->route("/template/pages/right/")                     ->to("template-pages#right");
    $sessionBridge->route("/template/pages/resize/")                    ->to("template-pages#resize");
    $sessionBridge->route("/template/pages/clean/")                     ->to("template-pages#clean");
