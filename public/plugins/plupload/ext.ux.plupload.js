        ...
        this.tbar = new Ext.Toolbar({
            enableOverflow: true,
              items: [
                new Ext.Button({
                    cls: "x-btn-text-icon",
                    text: config.addBtnTxt || 'Add files',
                    itemId: 'addButton',
                    icon: config.addBtnIcn,
                    disabled: true
                }),
                new Ext.Button({
                    cls: "x-btn-text-icon",
                    text: config.uploadBtnTxt || 'Upload',
                    handler: this.onStart,
                    scope: this,
                    disabled: true,
                    itemId: 'start',
                    icon: config.uploadBtnIcn
                }),
                new Ext.Button({
                    cls: "x-btn-text-icon",
                    text: config.cancelBtnTxt || 'Cancel',
                    handler: this.onCancel,
                    scope: this,
                    disabled: true,
                    itemId: 'cancel',
                    icon: config.cancelBtnIcn
                }),
                new Ext.SplitButton({
                    cls: "x-btn-text-icon",
                    text: config.deleteBtnTxt || 'Remove',
