Inprint.documents.briefcase.Access = function(parent, panels) {
    ...
    grid.getSelectionModel().on("selectionchange", function(sm) {
        ...
        if (sm.getCount() == 1) {
            if (access["update"]    == 'enabled') grid.btnUpdate.enable();
            ...
            if (access["recover"]   == 'enabled') grid.btnRestore.enable();
