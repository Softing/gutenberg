Inprint.settings.roles.Grid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function() {
        ...
        this.urls = {
            ...
            create:  _url("/settings/roles/create/"),
            enable:  _url("/settings/roles/enable/"),
            disable: _url("/settings/roles/disable/"),
            remove:  _url("/settings/roles/delete/")
        }
        ...
        Inprint.settings.roles.Grid.superclass.initComponent.apply(this, arguments);

    },

    onRender: function() {
        Inprint.settings.roles.Grid.superclass.onRender.apply(this, arguments);
