Inprint.settings.editions.Grid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function() {
        ...
        this.urls = {
            create:  _url("/settings/editions/create/"),
            enable:  _url("/settings/editions/enable/"),
            disable: _url("/settings/editions/disable/"),
            remove:  _url("/settings/editions/delete/")
        }

        this.store = Inprint.factory.Store.json("/settings/editions/list/");
        ...
        Inprint.settings.editions.Grid.superclass.initComponent.apply(this, arguments);

    },

    onRender: function() {
        Inprint.settings.editions.Grid.superclass.onRender.apply(this, arguments);
        this.store.load();
    },
