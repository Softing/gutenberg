Inprint.settings.members.RestrictionsPanel = Ext.extend(Ext.grid.EditorGridPanel, {
    initComponent: function() {

        this.urls = {
            list: _url("/access/rules/list/"),
            save: _url("/member/set/rules/"),
            fill: _url("/member/get/rules/"),
            role: _url("/role/get/rules/")
        }
        ...
        Inprint.settings.members.RestrictionsPanel.superclass.initComponent.apply(this, arguments);
    ...
    onRender: function() {
        Inprint.settings.members.RestrictionsPanel.superclass.onRender.apply(this, arguments);
    },
