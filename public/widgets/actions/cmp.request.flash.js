...
Ext.ns("Inprint.cmp.request");

Inprint.cmp.request.Flash = Ext.extend(Ext.Panel, {
    ...
    initComponent: function() {
        ...
        var selLength = 0;//this.parent.selLength;
        ...
        Inprint.cmp.request.Flash.superclass.initComponent.apply(this, arguments);

    },

    onRender: function() {
        Inprint.cmp.request.Flash.superclass.onRender.apply(this, arguments);
        //this.cmpInit();
    },
